...
public class FirestoreJDBCMetadata implements DatabaseMetaData {

    FirestoreJDBCConnection firestoreConn;
    Firestore firestore;

    public FirestoreJDBCMetadata(FirestoreJDBCConnection firestore) {
        this.firestoreConn = firestore;
        this.firestore = firestoreConn.getFirestore();
    }
    ...
    public String getURL() throws SQLException {
        return firestore.getOptions().getDatabaseId();
    }
    ...
    public String getDriverName() throws SQLException {
        return FirestoreJDBCDriver.class.getName();
    }

    @Override
    public String getDriverVersion() throws SQLException {
        return String.valueOf(FirestoreJDBCDriver.VERSION);
    }

    @Override
    public int getDriverMajorVersion() {
        return FirestoreJDBCDriver.VERSION;
    }
    ...
    public ResultSet getTables(String s, String s1, String s2, String[] strings) throws SQLException {
        //todo
        FirestoreJDBCStatement statement = new FirestoreJDBCStatement(firestore);
